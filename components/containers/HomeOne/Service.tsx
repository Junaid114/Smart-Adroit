...
import Four from "@/public/images/icon/services.jpg";
import Five from "@/public/images/icon/service-icon3.png";
import Six from "@/public/images/icon/services-icon3.png";
        ...
        <div className="row g-4">
          ...
          >
            ...
            >
              ...
              <h4>
                <Link href="service-details">AI Solutions</Link>
              </h4>
              <p>
                Elevate your business efficiency with customized AI solutions.
                We develop, deploy, and optimize AI-driven technologies that
                enhance your automate processes, and drive innovation—empowering
          ...
          >
            ...
            >
              ...
              <p>
                ...
                services. We create responsive, user-friendly websites tailored
                to your business needs, ensuring seamless user experiences and
                driving engagement.
              </p>
            </div>
          </div>
