...
import Three from "@/public/images/case/case-image2.webp";
import Four from "@/public/images/case/case-image3.jpg";
import Five from "@/public/images/case/case-image4.webp";
          ...
          <SwiperSlide>
            <div>
              <div className="case__item">
                ...
                <div className="case__content">
                  <span className="primary-color sm-font">Seo</span>
                  <h3>
                    <Link
                      href="case-details"
                      className="text-white primary-hover"
