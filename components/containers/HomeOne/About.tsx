            ...
            <div className="col-xl-6">
              <div className="section-header mb-40">
                ...
                <p
                  ...
                  data-aos-duration="1500"
                >
                  We are committed to delivering intelligent business solutions
                  that drive success. Our expertise in cutting-edge technology
                  and innovative strategies empowers businesses to thrive. We
                  blend creativity with precision, ensuring tailored solutions
                  that meet your unique needs and propel your business forward.
                </p>
              </div>
              <div
                className="row g-4 "
                ...
                <div className="col-md-6">
                  <div className="about__right-item">
                    ...
                    <div className="content">
                      ...
                      <p>Delivering excellence with every solution</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="about__right-item">
                    ...
                    <div className="content">
                      ...
                      <p>Always here to help, anytime you need us</p>
                    </div>
                  </div>
                </div>
              </div>
