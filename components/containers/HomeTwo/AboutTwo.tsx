...
import Seven from "@/public/images/about/signature.png";
          ...
          <div className="col-xl-6">
            <div className="section-header mb-40">
              ...
              <p
                ...
                data-aos-duration="1500"
              >
                At Smart Adroit, we are committed to delivering top-notch
                IT services designed to drive your business forward. Our team of
                experts provides comprehensive support, from initial
                consultation through to full-scale implementation, ensuring that
                your technology needs are met with precision and care.
              </p>
            </div>
            <div
            ...
            >
              ...
              <Image src={Seven} alt="singature" priority height={150} width={350} />
            </div>
          </div>
        </div>
      </div>
