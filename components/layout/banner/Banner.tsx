...
import One from "@/public/images/banner/banner-solid-left-shape.png";
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p
                    ...
                    className="mt-20"
                  >
                    Our tailored software solutions are designed to drive
                    innovation, streamline operations, and boost your business
                    growth. Whether you need custom development, cloud
                    solutions, or IT consulting, we have the expertise to take
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p
                    ...
                    className="mt-20"
                  >
                    Our team of experts is dedicated to delivering software
                    solutions that are not only robust and reliable but also
                    scalable to meet your evolving needs. Let’s work together to
